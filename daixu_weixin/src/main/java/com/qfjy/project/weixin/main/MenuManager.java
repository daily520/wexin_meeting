 ...
 */
	...
	public final static String REAL_URL="http://daily.natapp1.cc/"; //个人花生壳
	//public final static String REAL_URL = "http://wxmobsa.yidatec.com/weixin/"; //正式号服务器	
	
	public final static String appId="wx394eb878778720b8";
	public final static String appSecret = "7d0e35cf09f17cbe4bcc7ca6db01c8c3";
...
//-------------------------------------------------------
		...
		btn20.setName("统计排行榜");
		btn20.setType("view");
		btn20.setUrl("https://www.baidu.com/");
...
//------------------------------------------------------------		
		...
		btn31.setName("one more click,one more thing");
		btn31.setType("click");
		btn31.setKey("31");
